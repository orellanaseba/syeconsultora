(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function n(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(e){if(e.ep)return;e.ep=!0;const o=n(e);fetch(e.href,o)}})();const f=[{nombre:"Aizpurua 3200",imagenes:["aizpurua1.png","aizpurua2.png","aizpurua3.png","aizpurua4.png","aizpurua5.png","aizpurua6.png","aizpurua7.png","aizpurua-map.png"],precio:"155.000u$$",descripcion:`Esta nuevo, hermoso apartamento de tres ambientes en dupla.
        <li>°1Planta: Cocina, living, patio, baños completo y jardín</li>
        <li>°2Planta: dos dormitorios los dos trae placard</li>
        `,datosGenerales:[{antiguedad:"a estrenar",estados:"",categoria:"",frente:"",techo:"",lote:"",superficieCubierta:"34m2",superficieDescubierta:"",jardinFrente:"",jardinFondo:"7x4",patio:"2.90x4",entradaServicio:"",garages:"",terraza:"",galeria:"",quincho:"",parrilla:"",pileta:"",orientacion:"Aizpurua 3200",tipoPropiedad:"apartamento"}],datosAmbiente:[{hall:"",living:"5x4",cocina:"cocina y comedor 2.80x4",escritorio:"",toillete:"",baño:"completo",dormitorio:"2.60x3.50, 3x3",depedenciaServicio:"",playRoom:"",hallIntimo:"",office:"",lavadero:"",barrio:"Villa Urquiza",tipoPiso:"",calefaccion:"",aguaCaliente:"",aireAcondicionado:"",telefono:""}]},{nombre:"Balbin 3100",imagenes:["balbin1.png","balbin2.png","balbin3.png","balbin4.png","balbin5.png","balbin6.png","balbin7.png","balbin-map.png"],precio:"125.000u$$",descripcion:`Excelentes condiciones estas en muy buenos estados un apartamento de 4 piso.
        ...
        `,datosGenerales:[{antiguedad:"40 años",estados:"muy bueno",categoria:"",frente:"lateral",techo:"",lote:"",superficieCubierta:"48m2",superficieDescubierta:"4m2",jardinFrente:"",jardinFondo:"",patio:"",entradaServicio:"",garages:"",terraza:"si",galeria:"",quincho:"",parrilla:"",pileta:"",orientacion:"Balbin 3100",tipoPropiedad:"3 ambientes"}],datosAmbiente:[{hall:"1x1",living:"3x4",cocina:"cocina 2x3",escritorio:"",toillete:"",baño:"completo",dormitorio:"3x3(50), 3x2(60)",depedenciaServicio:"",playRoom:"",hallIntimo:"",office:"",lavadero:"si",barrio:"",tipoPiso:"parquet",calefaccion:"tiro balanceado",aguaCaliente:"calefón",aireAcondicionado:"",telefono:""}]},{nombre:"Conde y Taborini",imagenes:["conde1.png","conde2.png","conde3.png","conde4.png","conde-map.png"],precio:"155.000u$$",descripcion:`Estas en unas buenas condiciones, Son dos Propiedades horizontal.
        ...
        `,datosGenerales:[{antiguedad:"60 años",estados:"regular",categoria:"P.H.",frente:"",techo:"",lote:"",superficieCubierta:"120m2",superficieDescubierta:"60m2",jardinFrente:"",jardinFondo:"",patio:"si",entradaServicio:"",garages:"",terraza:"si",galeria:"",quincho:"si",parrilla:"si",pileta:"",orientacion:"Conde y Taborini",tipoPropiedad:"P.H."}],datosAmbiente:[{hall:"",living:"",cocina:"",escritorio:"",toillete:"",baño:"completo",dormitorio:"",depedenciaServicio:"",playRoom:"",hallIntimo:"",office:"",lavadero:"",barrio:"",tipoPiso:"",calefaccion:"",aguaCaliente:"",aireAcondicionado:"",telefono:""}]},{nombre:"Holmberg 4100",imagenes:["holmberg1.png","holmberg2.png","holmberg3.png","holmberg4.png","holmberg5.png","holmberg6.png","holmberg7.png","holmberg8.png","holmberg9.png"],precio:"85.000u$$",descripcion:`Excelente apartamento dos ambientes está en un lugar hermoso con muchos árboles.
        ...
        `,datosGenerales:[{antiguedad:"",estados:"",categoria:"",frente:"",techo:"",lote:"",superficieCubierta:"40m2",superficieDescubierta:"5m",jardinFrente:"",jardinFondo:"",patio:"",entradaServicio:"",garages:"",terraza:"",galeria:"",quincho:"",parrilla:"",pileta:"",orientacion:"Holmberg 4100",tipoPropiedad:"Apartamento"}],datosAmbiente:[{hall:"",living:"5x4",cocina:"2x40",escritorio:"",toillete:"",baño:"completo",dormitorio:"3x3",depedenciaServicio:"",playRoom:"",hallIntimo:"",office:"",lavadero:"",barrio:"Saavedra",tipoPiso:"parquet",calefaccion:"tiro balanceado",aguaCaliente:"calefón",aireAcondicionado:"",telefono:""}]},{nombre:"Miller 4600",imagenes:["miller1.png","miller2.png","miller3.png","miller4.png","miller5.png","miller6.png","miller7.png","miller8.png","miller9.png","miller10.png","miller11.png","miller12.png","miller13.png","miller14.png","miller15.png","miller16.png","miller17.png","miller-map.png"],precio:"Consultar",descripcion:`Excelente Triple X ambiente zona tranquila queda a 5 cuadra a plaza Sarmiento; Estas en muy buen estado.
        ...
        *Tomo departamento en Bariloche.*        
        `,datosGenerales:[{antiguedad:"20 años",estados:"muy bueno",categoria:"casa",frente:"",techo:"",lote:"",superficieCubierta:"162.m2",superficieDescubierta:"",jardinFrente:"",jardinFondo:"4x7",patio:"",entradaServicio:"",garages:"2 autos",terraza:"4x3.20",galeria:"",quincho:"",parrilla:"",pileta:"",orientacion:"Miller 4600",tipoPropiedad:"Casa"}],datosAmbiente:[{hall:"",living:"8.40x4",cocina:"cocina y comedor 2.90x2.70",escritorio:"",toillete:"2",baño:"completo",dormitorio:"18x4, 2.80x3.20",depedenciaServicio:"",playRoom:"4x4.60",hallIntimo:"",office:"",lavadero:"",barrio:"Saavedra",tipoPiso:"",calefaccion:"",aguaCaliente:"",aireAcondicionado:"",telefono:""}]},{nombre:"Munro Fleming 2500",imagenes:["munro1.png","munro2.png","munro3.png","munro4.png","munro-map.png"],precio:"150.000u$$",descripcion:`Excelente PH de 3 ambiente muy amplio todo a nuevo, 90m2 en 2 plantas.
        ...
        `,datosGenerales:[{antiguedad:"30 años",estados:"M.B.",categoria:"P.H.",frente:"si",techo:"tejas",lote:"",superficieCubierta:"52m",superficieDescubierta:"",jardinFrente:"si",jardinFondo:"si",patio:"",entradaServicio:"",garages:"cochera",terraza:"",galeria:"",quincho:"",parrilla:"",pileta:"",orientacion:"Villa Gessell",tipoPropiedad:"P.H."}],datosAmbiente:[{hall:"2x1",living:"6x3.50",cocina:"6x3.50, comedor 6x3.50",escritorio:"",toillete:"si",baño:"completo",dormitorio:"4x4, 3.50x2.80",depedenciaServicio:"",playRoom:"",hallIntimo:"",office:"",lavadero:"",barrio:"",tipoPiso:"",calefaccion:"",aguaCaliente:"",aireAcondicionado:"",telefono:""}]}],t=()=>{const a=document.querySelector(".leyes"),i=document.querySelector(".modal-leyes-container");a.addEventListener("click",()=>{i.classList.add("modal-open")}),y(i)},y=a=>{document.querySelector(".btn-closemodal").addEventListener("click",()=>{a.classList.remove("modal-open")})},d=()=>{const a=document.querySelectorAll(".galeria-imagenes img"),i=document.querySelector(".galeria-contenedor"),n=document.querySelector(".galeria-img");a.forEach(e=>{e.addEventListener("click",o=>{let r=o.target.getAttribute("src");i.classList.remove("cerrar-galeria"),i.classList.add("abrir-galeria"),n.src=r})}),document.querySelector(".btn-cerrar-galeria").addEventListener("click",()=>{i.classList.add("cerrar-galeria"),i.classList.remove("abrir-galeria")})},l=document.querySelector(".contenido"),h=()=>{l.innerHTML="",l.innerHTML=`
...
<div class="propiedades-texto-container">
    ...
    `,i++});let n=document.createElement("div");n.classList.add("galeria-contenedor"),n.innerHTML=`
...
<div class="footer-logo">
    <a href="index.html"><img class="logo-img" src="/imagenes/logo.png" alt=""></a>
        ...
        </div>`,l.appendChild(s),t(),d()},p=()=>{const a=document.querySelector(".form"),i=document.querySelector(".nombre-input"),n=document.querySelector(".telefono-input"),s=document.querySelector(".email-input"),e=document.querySelector(".textarea");a.addEventListener("submit",o=>{const r=i.value,c=s.value,g=n.value,u=n.value.length,b=e.value;let v=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;if(r===""||c===""||g===""||b==="")return o.preventDefault(),alert("Rellena todos los campos."),!1;if(!c.match(v))return o.preventDefault(),alert("Por favor, introduce un email válido."),!1;if(u<8)return o.preventDefault(),alert("ingresa un número de teléfono válido."),!1})},x=document.querySelector(".contenido"),A=()=>{x.innerHTML=`
<div class="banner">
...
<div class="propiedades-texto-container">
    ...
    <div class="datos">
        <ul class="datos-container datos-generales">
            ...
            <li><strong>Operación: </strong>${o.datosGenerales[0].operacion}</li>
            <li><strong>Dirección: </strong>${o.datosGenerales[0].direccion}</li>
            <li><strong>Ambientes: </strong>${o.datosGenerales[0].ambientes}</li>
            <li><strong>Dormitorios: </strong>${o.datosGenerales[0].dormitorios}</li>
            <li><strong>Baños: </strong>${o.datosGenerales[0].baños}</li>
            <li><strong>Luminosidad: </strong>${o.datosGenerales[0].luminosidad}</li>
            <li><strong>Estado: </strong>${o.datosGenerales[0].estado}</li>
            <li><strong>Entrada para auto: </strong>${o.datosGenerales[0].entradaAuto}</li>
            <li><strong>Próximo a: </strong>${o.datosGenerales[0].proximoA}</li>
        </ul>
        <ul class="datos-container datos-del-ambiente">
            <li class="datos-title">Medidas aproximadas</li>
            <li><strong>Frete jardín: </strong>${o.datosAmbiente[0].frenteJardin}</li>
            <li><strong>Living: </strong>${o.datosAmbiente[0].living}</li>
            <li><strong>Comedor: </strong>${o.datosAmbiente[0].comedor}</li>
            ...
            <li><strong>Dependencia servicio: </strong>${o.datosAmbiente[0].dependenciaServicio}</li>
            <li><strong>Patio: </strong>${o.datosAmbiente[0].patio}</li>
            <li><strong>Fondo jardín: </strong>${o.datosAmbiente[0].fondoJardin}</li>
        </ul>
    </div>
    <p>Agradecemos su elección, esperamos respuestas suyas.</p>
    </div>
    </div>
    `,n++});let s=document.createElement("div");s.classList.add("galeria-contenedor"),s.innerHTML=`
    <div class="galeria-imagen-contenedor">
        <i class="btn-cerrar-galeria fas fa-close"></i>
        <img class="galeria-img" src="" >
    </div>
...
<div class="footer-logo">
    <a href="index.html"><img class="logo-img" src="/imagenes/logo.png" alt=""></a>
        ...
        </div>`,a.appendChild(e),t(),d()},m=document.querySelectorAll(".ul-list .li-item .li-a"),q=a=>{m.forEach(i=>{i.classList.remove("selected")}),a.classList.add("selected")};m.forEach(a=>{a.addEventListener("click",i=>{q(i.target),i.target.textContent==="Propiedades"?h():i.target.textContent==="Sobre Nosotros"||i.target.textContent==="Servicios"?(A(),p()):i.target.textContent==="Alquileres"&&$()})});t();
